          ...
          <div class="modal-container">
            ...
            <div class="modal-footer">
              <slot name="footer">
                ...
                <button type="button" class="btn btn-default" @click="saveCategory">Save</button>
              </slot>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header" style="padding: 10px;">
            ...
            <button type="button" class="btn btn-default" style="float: right;margin: 10px;" @click="addCategory">New Category <i class="fa fa-plus-circle"></i></button>
          </div>
         </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <pagination v-model="page" :records="categories.category.length" :per-page="10" v-if="categories.category.length>10" style="margin: 0px 0 0 40%;"></pagination>
        </div>
      </div>
    </div>
    ...
    saveCategory: function () {
      ...
      if (this.catRename === this.catName && this.catName !== '' && this.catRename !== '') {
        ...
        docRef.doc('categoryId').update({
          'category': firebase.firestore.FieldValue.arrayUnion(thisI.catArray.charAt(0).toUpperCase() + thisI.catArray.substr(1))
        }).then(function () {
