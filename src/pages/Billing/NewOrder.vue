            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  />
                  <span
                    v-if="productname_alert"
                    style="color:red;float: left;align-items: center;"
                    >* {{ productname_alert }}</span
                  >
                </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  />
                  <span
                    v-if="orderdate_alert"
                    style="color:red;float: left;align-items: center;"
                    >* {{ orderdate_alert }}</span
                  >
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="file"
                    @change="filename"
                    accept="image/x-png,image/gif,image/jpeg,image/jpg,image/tiff,image/bmp,application/pdf,.xls,.txt,.odt"
                  />
                  <span
                    v-if="image_alert"
                    style="color:red;float: left;align-items: center;"
  ...
  methods: {
    registrationButton: function() {
      ...
      if (
        ...
        this.snackbar = true;
        if (this.productname === "") {
          this.productname_alert = "This field is required";
        }
        if (this.amount === "") {
          this.amount_alert = "This field is required";
        }
        if (this.note === "") {
          this.comment_alert = "This field is required";
        }
        if (this.category === "") {
          this.category_alert = "This field is required";
        }
        if (this.date === "") {
          this.orderdate_alert = "This field is required";
        }
        if (this.file === "") {
          this.image_alert = "This field is required";
        }
    ...
    keymonitor: function(event) {
      ...
      if (
        (event.which !== 46 || this.amount.indexOf(".") !== -1) &&
